    ...
    return (
        <aside
        ref={sidebar}
        className={`absolute left-0 top-0 z-9999 flex h-screen w-72.5 flex-col  bg-blue-50 overflow-y-hidden  duration-300 ease-linear dark:bg-boxdark lg:static lg:translate-x-0 transition-transform ${
        ...
        <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5 ">
            ...
            <h2 className="text-lg font-semibold text-black">QuickServe</h2>
            </NavLink>
        ...
        <div className="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear  bg-blue-50">
            {/* <!-- Sidebar Menu --> */}
                    ...
                    return (
                        ...
                        >
                            ...
                            <li>
                                ...
                                to="/business"
                                className={({ isActive }) =>
                                    "group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-green-400 " +
            ...
            <div className="">
                ...
                to="/auth/signup"
                className={({ isActive }) =>
                    "group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-red-600 " +
                    (isActive && "!text-white")
                }
                >
                Logout
